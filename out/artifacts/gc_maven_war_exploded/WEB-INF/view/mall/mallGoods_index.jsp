                    ...
                    <form class="navbar-form navbar-left" id="searchForm"
                        ...
                        <div class="form-group">
                            <label class="">商品名称</label> <input type="text"
                                                                value="${parameter.entity.name}" name="entity.name"
                                                                id="name"
                            ...
                            <select name="entity.types.id" id="type" class="form-control">
                                <option value="">所有</option>
...
<script type="text/javascript">
    $(function () {
            ...
            "ajax": {
                ...
                "data": function (d) {
                    return $.extend({}, d, {
                        ...
                        "entity.shelf": $('#shelf').val(),
                        "entity.goodsType.id": $('#type').val(),
                        "useDatatables": "true"
                    });
                }
            },
        ...
        $("#dataList").delegate("a.ajaxLink", "click", function (e) {
            ...
            var url = $(this).attr("href");
            $.ajax({
                url: url, method: method, complete: function (xhr, ts) {
