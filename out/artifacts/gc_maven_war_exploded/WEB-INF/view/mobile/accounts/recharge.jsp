...
<div class="con">
    ...
    <%--<span class="Title">${type.stateInfo}充值</span>--%>
    <%--<a href="" class="Home"><span></span></a>--%>
    <%--</header>--%>

    <form method="post" action="<c:url value="/mobile/accounts/commitRecharge.json"/>">
        <div class="panel">
            <div class="userInfo">
            ...
            <div class="transfer">
                ...
                <a>余额:${balance}</a>
                <div class="btn"><span>充值</span></div>
            </div>
        </div>
                ...
                $(form).ajaxSubmit({
                    ...
                    success: function (responseText, statusText, xhr, $form) {
                        ...
                        if (m.flag == "0") {//调用微信支付
                            ...
                            if(jp!=null&&jp!=""){
//                                alert(JSON.parse(jp));
                                callPay(JSON.parse(jp));
                            }else {
                                alert("未知错误，请联系管理员。没有支付参数!!");
                            }
                            <%--alert("充值成功!");--%>
            ...
            WeixinJSBridge.invoke(
                ...
                function (res) {
                    if (res.err_msg == "get_brand_wcpay_request:ok") {
                        alert("支付成功!");
                        var str = "<c:url value="/mobile/wallet.html"/>";
