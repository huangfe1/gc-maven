...
<script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.1.0.js">
</script>
<style type="text/css">
html {
...
<body>
	<div class="container" id="nav">
		<div class="row">
			...
			<div class="col-xs-4">
				<a class="thumbnail" href="<c:url value='/dmz/tmall/index.html'/>">
					<img data-src="" alt=""
		...
		<div class="row" id="products">
			<div class="col-md-12 col-xs-12">
				<div class="panel panel-info">
					...
					<div style="display:none" id="addressPlane" class="panel-body">
						<div class="col-md-12 col-xs-12">
							<form action="<c:url value='/tmall/pay/pay.json'/>"
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="editPostCode" onclick="callEditAddress();"
											tabIndex="12" name="postCode" value=""
											placeholder="输入邮政编码">
									</div>
									<div class="col-md-4 col-xs-4 text-error"></div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
                                        ...
                                        <input type="hidden" name="isUseAdvance" id="isUseAdvance" value="0"/>
                                        <input type="hidden" name="isUseVoucher" id="isUseVoucher"  value="0">
                                        <input type="hidden" name="d"   value="0.03">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<a class="btn btn-info btn-lg btn-block"
					href="<c:url value='/dmz/tmall/index.html?ref=${agentCode}'/>">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="winModalLabel">选择支付方式</h4>
				</div>
										...
										<div class="form-group">
											<ul class="list-group" id="yckPay">
												<li class="list-group-item"><div class="radio">
													<label> <input type="checkbox" onclick="return false" id="useAdvance" name="yxkpayment" checked="true"
																   id="yxkpayment" value="WX"> 预存款支付
													</label>
												</div></li>
											</ul>
				...
				<div class="modal-footer">
					...
					<div class="form-group">
						<div class="col-md-6 col-xs-6">
							<button type="button" class="btn btn-default btn-block quitBtn" tabindex="27" id="quitBtn" data-dismiss="modal" name="quitBtn"  data-loading-text="正在返回......">
								<span class="glyphicon glyphicon-remove-sign">&nbsp;</span>关闭
							</button>
						</div>
						<div class="col-md-6 col-xs-6">
							<button type="button" class="btn btn-danger btn-block" id="btnPay" tabindex="26"  name="saveBtn" value="saveBtn" data-loading-text="正在提交......">
								<span class="glyphicon glyphicon-credit-card">&nbsp;</span>确认发货
							</button>
						</div>
					</div>
	...
	<script type="text/javascript">
		$(function() {
            ...
            $("#btnPay").click(function(){
                var isUseAdvance=$("#useAdvance").is(":checked")?1:0;//选中为1  没有选中为0
                var isUseVoucher=$("#useVoucher").is(":checked")?1:0;//选中为1  没有选中为0
                $("#isUseAdvance").val(isUseAdvance);
                $("#isUseVoucher").val(isUseVoucher);
