		...
		<div class="row">
			<div class="col-xs-4">
				<a class="thumbnail" href="<c:url value='/pmall/uc/index.html?ref=${agentCode}'/>">
					...
					<div class="caption">
						<h6 class="text-center">优惠商城订单</h6>
					</div>
				</a>
			</div>
...
<div class="container">
	...
	<div class="container">
							...
							<c:forEach items="${pmshopcart.items}" var="item">
								<tr>
									...
									<td><button class="btn btn-danger btn-xs removeBtn"
											data-id="${item.value.goodgoodss.id}">删除</button></td>
								</tr>
							</c:forEach>
						</tbody>
						<tfoot>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<button class="btn btn-warning btn-lg btn-block toBtn" type="button"  data-loading-text="正在提交"   data-url="<c:url value='/pmall/shopcart/editAddress.html'/>"  <c:if test="${ empty pmshopcart or pmshopcart.quantity<1}">disabled='disabled'</c:if> >
