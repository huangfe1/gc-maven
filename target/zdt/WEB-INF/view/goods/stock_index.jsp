				...
				<div class="container-fluid">
					<div class="collapse navbar-collapse" id="top-navbar-collapse">
						<form class="navbar-form navbar-left" id="searchForm"
							role="search" action="<c:url value='/stock/index.html'/>"
							method="GET">
						...
						<table
							...
							<tbody id="dataList">
								<c:forEach items="${goods}" var="g">
									<tr data-row="${g.id}" <c:if test="${g.currentStock<=alertStock}"> class="danger"</c:if>>
										...
										<td><a class="btn btn-success default editBtn"
											...
											href="<c:url value='/stock/detail.html?goodsId=${g.id}' /> "><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>库存流水</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
