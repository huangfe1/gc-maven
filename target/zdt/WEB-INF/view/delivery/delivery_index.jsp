						...
						<form class="navbar-form navbar-left" id="searchForm"
							...
							<div class="form-group">
								...
								<label class="">申请发货人</label> <input type="text"
									value="${parameter.entity.applyAgent.agentCode}" name="entity.applyAgent.agentCode" id="applyAgent"
									autofocus class="typeahead form-control" placeholder="申请发货人编码">
								<label class="">联系电话</label> <input type="text"
																   value="${parameter.entity.address.mobile}" name="entity.address.mobile" id="mobile"
