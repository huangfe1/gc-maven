...
<body>
<br>
	<%--<form action="<c:url value='/advance/pay/commit.json'/>"--%>
	<form action="<c:url value='/advance/pay/alicommit.json'/>"
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 col-xs-12">
                                ...
                                <div class="controls" align="center">
                                    <input style="line-height: 2em"  type="text" id="voucher" name="advance" placeholder="数量">
                                </div>
										...
										.ajaxSubmit(
												{
													...
													success : function(
														...
														if (m.flag == "0") {
															$("#alertMessageBody").empty().html(m.message);
