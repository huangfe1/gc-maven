...
<body>
<div class="jumbotron">
	<h1 align="center">第二步,向下面指定支付宝转账</h1>
		<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<h4 class="text-warning">1,打开支付宝,点击转账.</h4>
				<h4 class="text-warning">2,选择转到支付宝账户</h4>
				<h4 class="text-warning">3,填写支付账号18802083025</h4>
				<h4 class="text-warning">4,备注栏填写代理编号(例如zmz123456)!</h4>
				<h6>订单编号：${order.out_trade_no}</h6>

				<h4 style="color: red;">收款账号:18802083025 </h4>
				<h4 style="color: blueviolet;">收款姓名:龙成</h4>
	...
	<div class="container" >
		<div class="row">
			<div class="col-xs-12">
				<button class="btn btn-lg btn-success btn-block" onclick="callpay();"><span class="fa fa-weixin"></span>转账后,点我进行查看</button>
			</div>
		</div>
	</div>
<br>
...
<jsp:include page="/WEB-INF/view/common/script_common.jsp"></jsp:include>
	<script type="text/javascript">
        function callpay(){
            window.location.href="<c:url value="/advance/my.html"/>" ;
        }
		$(function() {
