...
<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">优惠商城订单付款确认</h4>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<form action="<c:url value='/pm/order/pay.json'/>"
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-6">
					<button type="button" class="btn btn-danger btn-block btn-lg"
						...
						<span class="fa fa-money">&nbsp;</span>付款确认
					</button>
				</div>
			</div>
		</div>
										...
										.ajaxSubmit(
												{
													...
													success : function(
														...
														if (m.flag == "0") {
															...
															btn.button("reset");
															$("#alertMessageBody").empty().html("商品付款确认失败,"+m.message);
													...
													error : function(xhr,
															...
															errorThrown) {
														btn.button("reset");
														$("#alertMessageBody").empty().html("商品付款确认失败");
														$("#alertModal").modal({backdrop : "static",show : true});
													}
												});
							},
