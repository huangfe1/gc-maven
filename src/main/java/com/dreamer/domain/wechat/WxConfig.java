...
public class WxConfig {
    ...
    public final static String RECHARGE_NOTICE_URL = "http://ht.gcjx66.com/gc/dmz/mobile/accounts/recharge.json";

    public final static String PMALL_NOTICE_URL = "http://ht.gcjx66.com/gc/dmz/pmall/shopcart/wxPay.json";
