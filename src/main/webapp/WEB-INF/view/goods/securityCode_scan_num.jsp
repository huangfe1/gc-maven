                ...
                success: function (res) {
                    ...
                    if(code.indexOf("zmz365")>=0){
                        ...
                        if(code.indexOf("code")>=0){
                            ...
                            //益生菌错误防伪码 start编号错误  1拖40
                            if(end>=1465600&&end<=1705560){
                                start=end-39;
                            }
                            ...
                            if(start>=end){
                                ...
                                for(var i=start;i<=end;i++){
                                    if($.inArray(i,arr)==-1){
                                        $("#dataList").append("<tr id=trid" + index + "><td>"+index+"</td><td>" + i + "<input id=tid"+index+" type='hidden' name='codes' value=" + i + "></td><td ><a onclick='aclick(" + index + ")' class='btn btn-danger default ajaxLink'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span>删除</a></td></tr>");
                                        index++;
                                        arr.push(i);
                                    }else{
                                        alert("重复录入"+i);
