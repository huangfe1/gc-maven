...
<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">优惠商城订单退货</h4>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<form action="<c:url value='/pm/order/return.json'/>"
							...
							<div class="panel panel-info">
								...
								<div class="panel-body">
									<div class="col-md-12 col-xs-12">
										...
										<div class="form-group">
											<label for=refundReason class="col-sm-2 control-label">退货说明</label>
											<div class="col-sm-6">
												<input type="text" size="32" length="32" class="form-control" name="refundReason" id="refundReason">
											</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-6">
					<button type="button" class="btn btn-danger btn-block btn-lg"
						...
						<span class="fa fa-reply">&nbsp;</span>执行退货
					</button>
				</div>
			</div>
		</div>
										...
										.ajaxSubmit(
												{
													...
													success : function(
														...
														if (m.flag == "0") {
															...
															btn.button("reset");
															$("#alertMessageBody").empty().html("优惠商城订单退款操作失败,"+m.message);
													...
													error : function(xhr,
															...
															errorThrown) {
														btn.button("reset");
														$("#alertMessageBody").empty().html("订单退款失败");
														$("#alertModal").modal({backdrop : "static",show : true});
													}
												});
							},
