...
<jsp:include page="/WEB-INF/view/mall/mall_menu.jsp"></jsp:include>
	...
	<%-- 	<div class="row">
		...
		<%-- 		<div class="row">
			<div class="col-xs-12">
				<a class="btn btn-info btn-block btn-lg" href="<c:url value='/dmz/gmall/index.html'/>" id="sw">
					<span class="fa fa-desktop"></span>&nbsp特权商城
				</a>
			</div>
		</div>
		<br> --%>
		...
		<div class="row">
			<div class="col-xs-12">
				<a class="btn btn-info btn-block btn-lg" href="<c:url value='/transfer/my.html'/>" id="sw">
					<span class="glyphicon glyphicon-usd"></span>&nbsp转货退货
				</a>
			</div>
		</div>
		<br>
...
<%--<c:if test="${vip}">--%>
	...
	<%--<div class="row">--%>
		<%--<div class="col-xs-12">--%>
			<%--<a class="btn btn-info btn-block btn-lg" href="<c:url value='/advance/pay/index.html'/>" id="sw">--%>
				<%--<span class="glyphicon glyphicon-usd"></span>&nbsp预存款充值--%>
			<%--</a>--%>
		<%--</div>--%>
	<%--</div>--%>
	<%--<br>--%>
<%--</c:if>--%>
		...
		<!-- 店铺订单 -->
			...
			<div class="col-xs-12">
				<a class="btn btn-warning btn-block btn-lg" href="<c:url value='/delivery/agent/confirm.html'/>" id="sw">
					<span class="glyphicon glyphicon-plane"></span>&nbsp客户发货订单
				</a>
			</div>
		</div>
		<br> 
		<!--我的 -->
			<div class="row">
			<div class="col-xs-12">
				<a class="btn btn-warning btn-block btn-lg" href="<c:url value='/delivery/index.html'/>" id="sw">
					<span class="glyphicon glyphicon-plane"></span>&nbsp我的发货订单
				</a>
			</div>
		</div>
		<br> 
        ...
        <div class="row">
            <div class="col-xs-12">
                <a class="btn btn-success btn-block btn-lg" href="<c:url value='/agent/teqchildren.html?from=${user.id}'/>" id="sw">
                    <span class="fa fa-truck"></span>特权商城客户
                </a>
            </div>
        </div>
        <br>
		...
		<c:if test="${vip}">
			<div class="row">
				<div class="col-xs-12">
					<a class="btn btn-primary btn-block btn-lg" href="<c:url value='/voucher/record.html'/>" id="sw">
						<span class="fa fa-desktop"></span>预存款详情
					</a>
				</div>
			</div>
			<br>
