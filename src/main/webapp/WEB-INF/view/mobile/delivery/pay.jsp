            ...
            <div class="panel panel-default">
                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        总金额:<span style="font-size: 1.2em;color: red"> ${note.amount}￥</span>
                    </li>
                </ul>
            </div>
...
//            accountsPay();
    ...
    function accountsPay() {
        var url = "<c:url value="/mobile/note/accountsPay.json"/>";
        var param = {
            "nid":"${note.id}"
        };
        ...
        WeixinJSBridge.invoke(
            ...
            function (res) {
                if (res.err_msg == "get_brand_wcpay_request:ok") {
                    var str = "<c:url value="/mobile/delivery/records.html"/>";
