...
<header
    ...
    <%--<img src="<c:url value='/resources/images/gheader.jpg'/>"--%>
    <%--class="header-img">--%>
    <div id="myCarousel" class="carousel slide ">
        ...
        <div class="carousel-inner">
            <div class="item">
                <img src="<c:url value='/resources/images/theader.jpg'/>" alt="">
            </div>
            <div class="item active">
                <img src="<c:url value='/resources/images/theader1.jpg'/>" alt="广告2">
            </div>
            <div class="item">
                <img src="<c:url value='/resources/images/theader2.jpg'/>" alt="广告3">
            </div>
        </div>
...
<div class="container" id="nav">
    <div class="row">
        ...
        <div class="col-xs-3">
            <a class="thumbnail" href="<c:url value='/dmz/pmall/show.html'/>"> <img data-src="" alt=""
                                                                                     src="<c:url value='/resources/images/tuiguang.jpg'/>"
                                                                                     data-holder-rendered="true">
                <div class="caption">
        ...
        <div class="col-xs-3">
            <a class="thumbnail"
               href="<c:url value='/tmall/shopcart/index.html'/>"> <img
                    data-src="" alt=""
                    src="<c:url value='/resources/images/shopCart.jpg'/>"
                    data-holder-rendered="true">
                <div class="caption">
                    <h6 class="text-center">
                        购物车<span class="badge" id="shopcartQuantity">${tshopcart.quantity}</span>
                    </h6>
                </div>
            </a>
        </div>
    ...
    <span style="color:red;font-size: 1.2em">精彩推荐:</span><span
        style="color: #00aba9;margin-left: 2em">特权商城新品上线,赶紧抢购!!!</span>
</div>
...
<script type="text/javascript">
    $(function () {
        ...
        var query = function () {
            ...
            <%--var url = "<c:url value='/dmz/tmall/goods/query.json'/>";--%>
            $.getJSON("<c:url value='/dmz/tmall/goods/query.json'/>", param,
                function (datas) {
                    if (datas.length!= 0) {
                        var row = null;
...
//                            + parseInt($("#length").val()));
                        var start = $("#start");
                        start.val(parseInt(start.val()) + datas.length);
                    }else {
                        alert("到底了，没有更多产品了");
                    }
        ...
        $("#products").delegate(".detailBtn", "click", function (e) {
            ...
            e.stopPropagation();
            var id = $(this).attr("data-id");
            window.location = "<c:url value='/dmz/tmall/detail.html'/>" + "?id=" + id;
        });
