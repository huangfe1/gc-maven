...
<div class="modal-dialog modal-lg" role="document">
	<form action="<c:url value='/voucher/transfer.json'/>"
					...
					<div class="row">
						<div class="col-md-12 col-xs-12">
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<div class="form-group">
										<label for="editName" class="col-sm-2 control-label">转出人姓名</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="editAgentCode" class="col-sm-2 control-label">转出人编号</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="editName" class="col-sm-2 control-label">收款人姓名</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" required autofocus="autofocus"
									...
									<div class="form-group">
										<label for="editAgentCode" class="col-sm-2 control-label">收款人编号</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" required
